namespace NoChangeJSDOC {
    ...
    */
    ...
    class Circle extends Point {
        ...
        /**
         * Constructor requires x,y coordinate since it operates in this plane, see
         * {@link Point}
         * 
         * @param x numerical representation of the horizontal position 
         * @param y numerical representation of the vertical position 
         * @param radius the distance between the x,y coordinate and the edge of the
         * circle
         */
